...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        distance = 0
        def next_place(place):
            nonlocal distance
            distance += 1
            if place == beehive or distance > self.max_range:
                return None
            elif distance < self.min_range:
                return next_place(place.entrance)
            elif place.bees:
        ...
        if self.place.bees:
            ...
            return next_place(self.place.entrance)
